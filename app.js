class SVGEditor {
    constructor() {
        ...
        // Keep selectedNodes and nodeHandles as getters for backward compatibility
        Object.defineProperty(this, 'selectedNodes', {
            get: function() { return this.nodeSelectionManager.selectedNodes; }
        });
        ...
        // nodeHandles moved to nodeSelectionManager
    ...
    selectNodesInMarquee(marqueeX, marqueeY, marqueeWidth, marqueeHeight) {
        this.nodeSelectionManager.selectNodesInMarquee(marqueeX, marqueeY, marqueeWidth, marqueeHeight);
    }

    updateNodeHandleSelection() {
        this.nodeSelectionManager.updateNodeHandleSelection();
    }
    ...
    updateNodeHandleTransforms() {
        this.nodeSelectionManager.updateNodeHandleTransforms();
    }
    ...
    selectNode(nodeHandle, multiSelect = false) {
        this.nodeSelectionManager.selectNode(nodeHandle, multiSelect);
    }

    clearNodeSelection() {
        this.nodeSelectionManager.clearNodeSelection();
    }
    ...
    showNodeHandles(element) {
        this.nodeSelectionManager.showNodeHandles(element);
    }
    
    showElementHandles(element) {
        this.nodeSelectionManager.showElementHandles(element);
    }

    clearNodeHandles() {
        this.nodeSelectionManager.clearNodeHandles();
    }
